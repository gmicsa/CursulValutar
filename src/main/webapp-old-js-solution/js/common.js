...
BrowserDetect.isBrowserSupported = function(){
    return (BrowserDetect.browser == "Chrome" && BrowserDetect.version >= 6) 
...
if(!BrowserDetect.isBrowserSupported()){
    document.location = 'http://' + document.location.host + '/html/browsers.html';
}